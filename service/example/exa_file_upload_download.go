...
func (e *FileUploadAndDownloadService) UploadFile(header *multipart.FileHeader, noSave string) (string, error) {
	oss := upload.NewOss()
	filePath, key, uploadErr := oss.UploadFile(header)
	fmt.Println("filePath:", filePath, "key:", key, "uploadErr:", uploadErr)
	if uploadErr != nil {
		return "", uploadErr
	}
	//if noSave == "0" {
